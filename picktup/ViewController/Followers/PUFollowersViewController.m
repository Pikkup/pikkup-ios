...
@interface PUFollowersViewController ()
...
@implementation PUFollowersViewController
...
- (void)reloadData {
    ...
    [PUConnect.sharedConnect followersForUser:PUConnect.sharedConnect.user page:page count:kDefaultFetchCount onSuccess:^(NSMutableArray *users) {
        self.people = users;
